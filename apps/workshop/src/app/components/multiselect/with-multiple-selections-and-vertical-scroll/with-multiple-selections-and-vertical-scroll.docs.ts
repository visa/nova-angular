...
/** #docs */
@Component({
  selector: 'nova-workshop-multiselect-with-multiple-selections-and-vertical-scroll',
  templateUrl: './with-multiple-selections-and-vertical-scroll.docs.html',
  standalone: true,
  imports: [CommonModule, NovaLibModule, VisaChevronDownTiny, VisaChevronUpTiny, VisaClearAltTiny]
})
export class MultiselectWithMultipleSelectionsAndVerticalScrollComponent implements AfterViewInit {
