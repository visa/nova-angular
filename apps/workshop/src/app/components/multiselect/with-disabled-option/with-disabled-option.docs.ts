...
/** #docs */
@Component({
  selector: 'nova-workshop-multiselect-with-disabled-option',
  templateUrl: './with-disabled-option.docs.html',
  standalone: true,
  imports: [CommonModule, NovaLibModule, VisaChevronDownTiny, VisaChevronUpTiny, VisaClearAltTiny]
})
export class WithDisabledOptionMultiselectComponent implements AfterViewInit {
