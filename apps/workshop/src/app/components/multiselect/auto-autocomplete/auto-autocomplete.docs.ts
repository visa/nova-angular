...
/** #docs **/
@Component({
  selector: 'nova-workshop-multiselect-auto-autocomplete',
...
export class AutoAutocompleteMultiselectComponent implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    if (this.combobox) {
      ...
      // this.comboboxService.autoFilterBasedOnList(this.combobox, this.cardTypes, 'label');
