...
/** #docs */
@Component({
  selector: 'nova-workshop-multiselect-inline-message',
  templateUrl: './inline-message.docs.html',
  standalone: true,
  imports: [CommonModule, NovaLibModule, VisaChevronDownTiny, VisaChevronUpTiny, VisaClearAltTiny]
})
export class InlineMessageMultiselectComponent implements AfterViewInit {
