...
/** #docs */
@Component({
  selector: 'nova-workshop-multiselect-with-scroll-bar',
  templateUrl: './with-scroll-bar.docs.html',
  standalone: true,
  imports: [CommonModule, NovaLibModule, VisaChevronDownTiny, VisaChevronUpTiny, VisaClearAltTiny]
})
export class WithScrollMultiselectComponent implements AfterViewInit {
