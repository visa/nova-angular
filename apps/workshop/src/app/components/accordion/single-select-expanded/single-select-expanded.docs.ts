...
/** #docs */
@Component({
  selector: 'nova-workshop-accordion-single-select-expanded',
  templateUrl: './single-select-expanded.docs.html',
  standalone: true,
  imports: [CommonModule, NovaLibModule, VisaChevronRightTiny, VisaChevronDownTiny]
})
export class SingleSelectExpandedAccordionComponent {}
