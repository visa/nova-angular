...
@Component({
  selector: 'nova-workshop-panel-modal-expandable-with-skrim',
  templateUrl: './modal-expandable-with-skrim.docs.html',
  standalone: true,
  imports: [NovaLibModule, VisaMediaRewindTiny, VisaMediaFastForwardTiny]
})
export class ModalExpandableSkrimPanelComponent {
  constructor() {
