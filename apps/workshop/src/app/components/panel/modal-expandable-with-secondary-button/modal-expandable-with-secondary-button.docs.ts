...
@Component({
  selector: 'nova-workshop-panel-modal-expandable-with-secondary-button',
  templateUrl: './modal-expandable-with-secondary-button.docs.html',
  standalone: true,
  imports: [NovaLibModule, VisaMediaRewindTiny, VisaMediaFastForwardTiny]
})
export class ModalExpandableSecondaryButtonPanelComponent {
  constructor() {
