...
@Component({
  ...
  standalone: true,
  selector: 'nova-workshop-progress-indeterminate-progress-bar',
  templateUrl: './indeterminate-progress-bar.docs.html'
})
export class NovaIndeterminateProgressBarProgressComponent {
  constructor() {}
