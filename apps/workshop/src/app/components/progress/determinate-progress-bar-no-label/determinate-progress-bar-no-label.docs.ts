...
@Component({
  ...
  standalone: true,
  selector: 'nova-workshop-progress-determinate-progress-bar-no-label',
  templateUrl: './determinate-progress-bar-no-label.docs.html'
})
export class NovaDeterminateProgressBarNoLabelProgressComponent {
