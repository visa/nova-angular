...
@Component({
  ...
  standalone: true,
  selector: 'nova-workshop-progress-indeterminate-circular-progress',
  templateUrl: './indeterminate-circular-progress.docs.html'
})
export class NovaIndeterminateCircularProgressComponent {
  constructor() {}
