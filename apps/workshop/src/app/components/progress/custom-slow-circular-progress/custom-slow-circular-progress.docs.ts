...
@Component({
  ...
  standalone: true,
  selector: 'nova-workshop-progress-custom-slow-circular-progress',
  templateUrl: './custom-slow-circular-progress.docs.html'
})
export class NovaCustomSlowCircularProgressComponent {
  constructor() {}
