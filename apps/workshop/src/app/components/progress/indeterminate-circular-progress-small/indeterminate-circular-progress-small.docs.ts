...
@Component({
  ...
  standalone: true,
  selector: 'nova-workshop-progress-indeterminate-circular-progress-small',
  templateUrl: './indeterminate-circular-progress-small.docs.html'
})
export class NovaIndeterminateCircularProgressSmallComponent {
  constructor() {}
