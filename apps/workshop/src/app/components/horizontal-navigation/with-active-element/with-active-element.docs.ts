...
@Component({
  selector: 'nova-workshop-horizontal-nav-with-active-element',
  templateUrl: './with-active-element.docs.html',
  standalone: true,
  imports: [
    CommonModule,
    NovaLibModule,
...
export class WithActiveElementHorizontalNavComponent {
