...
export class ErrorCheckboxComponent {
  @ViewChild(CheckboxDirective)
  errorCheckbox: CheckboxDirective;
  isInvalid = false;

  handleReset() {
    this.isInvalid = false;
    this.errorCheckbox.checked = false;
  }

  handleSubmit() {
    this.isInvalid = !this.errorCheckbox.checked;
    if (this.isInvalid) this.errorCheckbox.el.nativeElement.focus();
  }
}
