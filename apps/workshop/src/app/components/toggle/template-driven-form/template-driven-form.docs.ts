...
import { NovaLibModule, ToggleDirective } from '@visa/nova-angular';
import { VisaErrorTiny } from '@visa/nova-icons-angular';

/** #framework-specific */
@Component({
  selector: 'nova-workshop-toggle-template-driven-form',
...
export class TemplateDrivenFormToggleComponent {
  @ViewChildren(ToggleDirective) toggles: QueryList<ToggleDirective>;
  ...
  handleFormSubmit(form: NgForm) {
    ...
    if (this.isInvalid) {
      document.getElementById('toggle-template-group-1')?.focus();
    }
  }
