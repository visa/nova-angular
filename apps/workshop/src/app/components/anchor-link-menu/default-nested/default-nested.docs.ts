...
@Component({
  ...
  standalone: true,
  selector: 'nova-workshop-anchor-link-menu-default-nested',
  templateUrl: './default-nested.docs.html'
})
export class NovaDefaultNestedAnchorLinkMenuComponent implements AfterViewInit {
