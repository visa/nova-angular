...
@Component({
  ...
  standalone: true,
  selector: 'nova-workshop-anchor-link-menu-right-to-left',
  templateUrl: './right-to-left.docs.html'
})
export class NovaRightToLeftAnchorLinkMenuComponent implements AfterViewInit {
