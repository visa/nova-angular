...
/** #docs */
@Component({
  selector: 'nova-workshop-tabs-stacked-disabled',
  templateUrl: './stacked-disabled.docs.html',
  standalone: true,
  imports: [CommonModule, NovaLibModule, VisaHomeLow, VisaReceiptLow, VisaStatisticsLow, VisaEmailLow]
})
export class StackedDisabledTabsComponent {
  selectedButtonTab = 0;
  ...
  tabContent = [
    {
      ...
      id: 'nova-stacked-tabs-disabled-0',
      icon: 'home'
    },
    {
      tabLabel: 'Label 2',
      text: 'This is content area for label 2',
      id: 'nova-stacked-tabs-disabled-1',
      icon: 'receipt'
    },
    {
      tabLabel: 'Label 3',
      text: 'This is content area for label 3',
      id: 'nova-stacked-tabs-disabled-2',
      icon: 'statistics',
      disabled: true
    },
    {
      ...
      id: 'nova-stacked-tabs-disabled-3',
      icon: 'email'
    }
  ];
