...
import { VisaAnalyticsTiny, VisaCalendarTiny, VisaControlsTiny } from '@visa/nova-icons-angular';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, NovaLibModule, VisaAnalyticsTiny, VisaControlsTiny, VisaCalendarTiny]
})
