...
/** #docs */
@Component({
  selector: 'nova-workshop-tabs-horizontal-with-icon',
  templateUrl: './horizontal-with-icon.docs.html',
  standalone: true,
  imports: [CommonModule, NovaLibModule, VisaStatisticsTiny, VisaTopicTiny, VisaEmailTiny, VisaHomeTiny]
})
export class HorizontalWithIconTabsComponent {
  selectedButtonTab = 0;
  ...
  tabContent = [
    {
      ...
      id: 'nova-horizontal-tabs-with-icon-0',
      icon: 'statistics'
    },
    {
      tabLabel: 'Label 2',
      text: 'This is content area for label 2',
      id: 'nova-horizontal-tabs-with-icon-1',
      icon: 'topic'
    },
    {
      tabLabel: 'Label 3',
      text: 'This is content area for label 3',
      id: 'nova-horizontal-tabs-with-icon-2',
      icon: 'email'
    },
    {
      tabLabel: 'Label 4',
      text: 'This is content area for label 4',
      id: 'nova-horizontal-tabs-with-icon-3',
      icon: 'home'
    }
  ];
