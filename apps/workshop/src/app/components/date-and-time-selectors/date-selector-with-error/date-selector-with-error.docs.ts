...
@Component({
  ...
  standalone: true,
  selector: 'nova-workshop-date-time-selector-date-selector-with-error',
  templateUrl: './date-selector-with-error.docs.html'
})
export class InvalidDateSelectorDateTimeComponent {
