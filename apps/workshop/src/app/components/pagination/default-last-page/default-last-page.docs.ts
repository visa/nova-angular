...
@Component({
  selector: 'nova-workshop-pagination-default-last-page',
...
export class PaginationDefaultLastPageComponent implements AfterViewInit {
  ...
  showEndingEllipses: boolean = false;
