...
@Component({
  selector: 'nova-workshop-pagination-default-middle-page',
  templateUrl: './default-middle-page.docs.html',
...
export class PaginationDefaultMiddlePageComponent implements AfterViewInit {
  ...
  middleLimit: number = 3;
  startEndLimit: number = 3;
  startPage: number = 1;
  ...
  showStartingEllipses: boolean = true;
